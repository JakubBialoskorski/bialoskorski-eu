...
export default function CymbalkiPrivacyPage() {
  return (
    <>
    <Head>
      <title>Jakub Białoskórski - Cymbalki Privacy Policy</title>
      <link rel="icon" href={`${process.env.NEXT_PUBLIC_FAVICON}/favicon.ico`} />
      <script src="/transition.js" async />
    </Head>
      <div id="menu">
        <div id="menu-items">
          <Link href="https://apps.apple.com/us/app/dot-xylophone/id1544977962"><div className="menu-item">back to AppStore</div></Link>
        </div>
            ...
            <div className="flex flex-wrap -m-1 md:-m-2">
                <div className="flex flex-wrap w-full">
                    <div className="w-full p-1 md:p-1 text-sm">
                            ...
                            <p>**Privacy Policy**</p>
                            Jakub Bialoskorski built the Cymbalki app as a Free app. This SERVICE is provided by Jakub Bialoskorski at no cost and is intended for use as is.
