...
export default function CymbalkiSupportPage() {
  return (
    <>
    <Head>
      <title>Jakub Białoskórski - Cymbalki support page</title>
                    ...
                    <div className="w-full p-1 md:p-2">
                        <div className="flex flex-wrap w-1/3">
                            <div className="w-full p-1 md:p-12">
                                <Link href="https://apps.apple.com/pl/app/dot-xylophone/id1544977962"><img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
