...
export default function PredkoscPrivacyPage() {
  return (
    <>
    <Head>
      <title>Jakub Białoskórski - Predkosc Privacy Policy</title>
            ...
            <div className="flex flex-wrap -m-1 md:-m-2">
                <div className="flex flex-wrap w-full">
                    <div className="w-full p-1 md:p-1 text-sm">
                        <div className="flex flex-wrap w-full">
                            <p>**Privacy Policy**</p>
                            Jakub Bialoskorski built the Predkosc app as a Free app. This SERVICE is provided by Jakub Bialoskorski at no cost and is intended for use as is.
